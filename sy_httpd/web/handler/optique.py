    ...
    def get(self):
        ...
        if out.ok() and user_id:
            ...
            qry = self.db_session.query(saga_db.ProcessPV) \
                ...
                .filter(saga_db.ProcessRoutingGTI.processName == 'FIBREOPTIQUE') \
...
class DashboardBdoHandler(web.handler.JsonHandler):
    ...
    def get(self):
        ...
        if out.ok() and user_id:
            ...
            qry = self.db_session.query(saga_db.ProcessCirce) \
                .order_by(saga_db.ProcessCirce.dateRequestCirce.desc())
